                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input
                                                        type="number" id="postcode" name="postcode"
                                                        @change="fetchAddress"
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input
                                                        type="radio" id="gender0" name="gender"
                                                        v-model="form.gender"
                                                        value="0">
                                                    <label for="gender0">男性</label>
                                                    <input
                                                        type="radio" id="gender1" name="gender"
                                                        v-model="form.gender"
                                                        value="1">
                                            ...
                                            <div class="p-2 w-full">
                                                <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Store</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
